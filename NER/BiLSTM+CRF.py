...
from Ner_baseline.BiLSTM_CRF.data_processor import Mydataset, get_vocab, get_label_map
from Ner_baseline.BiLSTM_CRF.model import BiLSTM_CRF
...
vocab = get_vocab('../mydatatrain.txt')
label_map = get_label_map()
print('label_map-----', label_map)

train_dataset = Mydataset('../mydata/train.txt', vocab, label_map)
valid_dataset = Mydataset('../mydata/eval.txt', vocab, label_map)
...
def train():
    ...
    for epoch in range(epochs):
        ...
        if score > best_score:
            ...
            best_score = score
            torch.save(model.state_dict(), 'model_91.bin')
